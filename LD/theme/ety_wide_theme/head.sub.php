...
<link rel="shortcut icon" type="image/x-icon" href="<?php echo G5_THEME_URL?>/img/favicon0812.jpg" />
<?php
if (G5_IS_MOBILE) {
...
?>
<title>그누보드를 사용하여 제작한 사이트 입니다</title>
...
<link rel="stylesheet" href="/css/LD.css?ver=<?php echo time() ; ?>">

<script src="/js/LD.js"></script>
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=67a33540878d761aa83189f0fc755bdd"></script>
