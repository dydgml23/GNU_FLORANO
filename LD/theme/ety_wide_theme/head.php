	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div id="tnb">
					<ul>
            <li><a href="<?php echo G5_URL?>/bbs/board.php?bo_table=notice"><?php echo latest('swiper_notice','notice',5,50) ; ?></a></li>
					</ul>
				</div>
			</div><!-- /col -->
		</div><!-- /row -->
...
<nav class="navbar fixed-top navbar-expand-lg navbar-white bg-white fixed-top">
  <div class="container">
    ...
    <?php echo latest('basic_img','Logo',1,50); ?>
    <?php echo latest('basic_img','mbLogo',1,50); ?>
  </a>
	...
	<div class="collapse navbar-collapse" id="navbarResponsive" data-hover="dropdown" data-animations="fadeIn fadeIn fadeInUp fadeInRight">
	  <ul class="navbar-nav ml-auto">
		...
		?>
			...
			<?php }else{?>
				<li class="nav-item">
				<a class="nav-link en2 f16 page-scroll" href="<?php echo $row['me_link']; ?>" target="_<?php echo $row['me_target']; ?>"><?php echo $row['me_name'] ?></a>
				</li>
			<?php }?>
		</li>
